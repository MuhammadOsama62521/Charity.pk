...
import { Form,
    ...
    class shokatkhanum extends Component {
        ...
        state = {
          ...
          handleApprove=(key)=>{
            ...
            if(this.state.price===''){swal("Please Enter Price")}
              ...
              firebase.database().ref().child('shokatkhanum').child('product').child(key).update({approval:true,price:this.state.price})
              swal("Approved")
            }
          }

          handleUnapprove=(key)=>{
            firebase.database().ref().child('shokatkhanum').child('product').child(key).update({approval:false,price:'0'})
            swal("Unapproved")
          }
                              ...
                              <div className="Vendor">
                                    ...
                                    <Card style={{ width: '21.5rem' }}>
                                        ...
                                        <Card.Body>
                                            ...
                                            <Card.Link style={{paddingBottom:"10px"}} >Set price</Card.Link>
                                            <br/>
